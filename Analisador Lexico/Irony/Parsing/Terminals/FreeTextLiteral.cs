...
namespace Analisador_Lexico.Irony.Parsing.Terminals {
  ...
  public class FreeTextLiteral : Terminal {
    ...
    private Token TryMatchContentSimple(ParsingContext context, ISourceStream source) {
      ...
      if (string.IsNullOrEmpty(tokenText) && (this.FreeTextOptions & FreeTextOptions.AllowEmpty) == 0)
        return null; 
    ...
    private Token TryMatchContentExtended(ParsingContext context, ISourceStream source) {
      ...
      if (string.IsNullOrEmpty(text) && (this.FreeTextOptions & FreeTextOptions.AllowEmpty) == 0)
        return null;
