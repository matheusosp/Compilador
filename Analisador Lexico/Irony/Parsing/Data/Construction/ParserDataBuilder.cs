...
using Analisador_Lexico.Irony.Parsing.Parser.SpecialActionsHints;
...
namespace Analisador_Lexico.Irony.Parsing.Data.Construction { 
  ...
  internal partial class ParserDataBuilder {
    ...
    #endregion
    internal static StringSet ComputeGroupedExpectedSetForState(Grammar.Grammar grammar, ParserState state) {
