...
namespace Analisador_Lexico.Irony.Ast {
  ...
  public class AstNodeConfig {
    ...
    public Func<object> DefaultNodeCreator; //default method for creating AST nodes; compiled dynamic method, wrapper around "new nodeType();"
